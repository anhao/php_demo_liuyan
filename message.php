...
if($_rows['tg_uniqid']==$_COOKIE['uniqid']){
    ...
    if(@$_GET['action']=='write'){
        ...
        _select("insert into tg_message(tg_touser,tg_fromuser,tg_content,tg_date) 
...
<section id="message">
    <div class="container">
        ...
        <form action="?action=write" class="from-horizontal" method="post">
            ...
            <textarea name="content" id="yzcontent"class="form-control" rows="3" placeholder="输入你的发送的短信"></textarea>
            <br>
            <div class="row">
